...
const neglected = { ...emptyMeasurement('http://example-construction.ca'), ok: true,
  ...
  freshness: { copyrightYear: 2014, generator: 'WordPress 4.1', brokenLinks: ['/services/roofing', '/contact-us.html'], lastModified: '2014-08-19T00:00:00Z' }
}
...
const solid = { ...emptyMeasurement('https://example-tours.ca'), ok: true,
  ...
  https: { enabled: true, redirectsToHttps: true, mixedContent: [] },
  mobile: { hasViewportMeta: true, viewportContent: 'width=device-width, initial-scale=1', horizontalOverflowPx: 0, tapTargetsUnder44: 1, smallestTapTargetPx: 40 },
...
const unreachable = { ...emptyMeasurement('https://example-gone.ca'), ok: false, error: 'ENOTFOUND' }

for (const [name, m] of Object.entries({ neglected, solid, unreachable })) {
